...
{\normalfont\bfseries} % Напівжирний шрифт
...
% Пункт 1.1.1 (З абзацу, напівжирний)
\titleformat{\subsubsection}[block]
{\normalfont\bfseries} % ТЕЖ НАПІВЖИРНИЙ ШРИФТ
...
% ДОБАВИТЬ ЭТУ СТРОКУ:
\numberwithin{figure}{section} % Нумерация рисунков внутри раздела (1.1, 1.2 и т.д.)
...
\addto\captionsukrainian{%
	\renewcommand{\refname}{Список бібліографічних посилань використаних джерел}%
}