...
\end{frame}
	% --- Слайд 6: Висновки ---
\begin{itemize}
	\item \textbf{Проведено ґрунтовний аналіз} існуючих класичних методів масштабування зображень, визначено їхні математичні особливості та характерні візуальні артефакти (аліасинг, розмиття, ефект «дзвеніння»).
