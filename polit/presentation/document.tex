...
\begin{frame}{Метрики оцінки якості масштабування}
	\textbf{MSE:}
	\begin{equation*}
		MSE = ...
	\end{equation*}
...
\begin{frame}{Результати}
		...
		\begin{figure}
	\begin{center}
		\includegraphics[width=0.55\linewidth]{PexelsLCIvsBIC.png} \\
	\caption{Результати тестування на датасеті PEXELS300 для випадку зменшення}
\end{center}
	\end{figure}
